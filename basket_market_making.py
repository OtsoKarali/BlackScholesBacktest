...
class Trader:
    def __init__(self):
        ...
        self.strategies = {
            Product.CROISSANTS: MarketMakingStrategy(Product.CROISSANTS, limits[Product.CROISSANTS]),
            Product.JAMS: MarketMakingStrategy(Product.JAMS, limits[Product.JAMS]),
            Product.DJEMBES: MarketMakingStrategy(Product.DJEMBES, limits[Product.DJEMBES]),
            Product.PICNIC_BASKET1: MarketMakingStrategy(Product.PICNIC_BASKET1, limits[Product.PICNIC_BASKET1]),
            Product.PICNIC_BASKET2: MarketMakingStrategy(Product.PICNIC_BASKET2, limits[Product.PICNIC_BASKET2]),
        }
